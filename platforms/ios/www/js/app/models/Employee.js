  ...
  define(function(require) {
    ...
    Employee = Backbone.Model.extend({
      initialize: function() {
        ...
        return this.reports.parent = this;
      },
      sync: function(method, model, options) {
        if (method === "read") {
          return findById(parseInt(this.id)).done(function(data) {
    ...
    EmployeeCollection = Backbone.Collection.extend({
      ...
      sync: function(method, model, options) {
        if (method === "read") {
          return findByName(options.data.name).done(function(data) {
            return options.success(data);
          });
        }
      }
    ...
    ReportsCollection = Backbone.Collection.extend({
      ...
      sync: function(method, model, options) {
        if (method === "read") {
          return findByManager(this.parent.id).done(function(data) {
            return options.success(data);
          });
        }
      }
